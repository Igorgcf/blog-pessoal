...
@RequestMapping("/postagens") // define quais urls essa clase irá gerar as reqisições
@CrossOrigin(origins = "*", allowedHeaders = "*") // habilita requisições feitas de qualquer fonte externa
public class PostagemController {

	@Autowired // inversão/injecão de dependencia
	...
	public ResponseEntity<List<Postagem>> findAllByTituloContainingIgnoreCase(@PathVariable String titulo) {
